...
export const myTransport = {
  ...
  stops: [
    ...
    { name: 'Illusio Public School', time: '08:00 AM', home: false },
  ],
}
...
export const staffUsers = [
  { id: 'u-001', name: 'Priya Nair', email: 'priya.nair@illusio.edu.in', role: 'Administrator', mfa: true, lastActive: 'Just now' },
  { id: 'u-002', name: 'Rahul Deshmukh', email: 'rahul.d@illusio.edu.in', role: 'Teacher', mfa: true, lastActive: '2h ago' },
  { id: 'u-003', name: 'Sunita Iyer', email: 'sunita.i@illusio.edu.in', role: 'Teacher', mfa: false, lastActive: 'Yesterday' },
  { id: 'u-004', name: 'Meena Kale', email: 'meena.k@illusio.edu.in', role: 'Office Staff', mfa: true, lastActive: '3d ago' },
]
