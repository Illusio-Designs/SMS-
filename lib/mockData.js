...
export const users = [
  ...
  },
  {
    ...
    role: 'finance',
    name: 'Anil Kulkarni',
    title: 'Financial Manager · All Branches',
    email: 'anil.finance@greenwood.edu.in',
    avatar: 'AK',
  },
  {
    id: 'u-system',
    role: 'system',
    name: 'Platform Admin',
    title: 'System Administrator · Scholr',
    email: 'superadmin@scholr.app',
    avatar: 'PA',
  },
]
...
// ===========================================================================
// Branches, Financial management, Audit/System logs, System-admin (tenants).
// ===========================================================================

// --- Branches of this school ------------------------------------------------
export const branches = [
  { id: 'BR-1', code: 'main', name: 'Main Campus', city: 'Kothrud, Pune', head: 'Priya Nair', students: 820, staff: 58, collectedPct: 52 },
  { id: 'BR-2', code: 'north', name: 'North Branch', city: 'Baner, Pune', head: 'Rakesh Iyer', students: 340, staff: 22, collectedPct: 41 },
  { id: 'BR-3', code: 'city', name: 'City Branch', city: 'Camp, Pune', head: 'Fatima Shaikh', students: 124, staff: 9, collectedPct: 47 },
]

// --- Per-branch financial summary (Financial Manager) -----------------------
export const branchFinance = [
  { branchId: 'BR-1', branch: 'Main Campus', billed: 3150000, collected: 1638000, pending: 1150000, overdue: 362000, defaulters: 34 },
  { branchId: 'BR-2', branch: 'North Branch', billed: 1300000, collected: 533000, pending: 620000, overdue: 147000, defaulters: 19 },
  { branchId: 'BR-3', branch: 'City Branch', billed: 470000, collected: 221000, pending: 210000, overdue: 39000, defaulters: 7 },
]

export const financeKpis = {
  billed: 4920000, collected: 2392000, pending: 1980000, overdue: 548000,
  collectionRate: 49, defaulters: 60,
}

// Recent financial transactions (Financial Manager ledger)
export const transactions = [
  { id: 'TXN-9821', at: '2026-07-13 10:24', student: 'Aarav Mehta', branch: 'Main Campus', head: 'Term 1 Tuition', amount: 38500, method: 'UPI · Google Pay', status: 'Success' },
  { id: 'TXN-9820', at: '2026-07-13 09:58', student: 'Ananya Rao', branch: 'Main Campus', head: 'Term 1 Full', amount: 38500, method: 'Card', status: 'Success' },
  { id: 'TXN-9819', at: '2026-07-12 17:12', student: 'Rohan Das', branch: 'North Branch', head: 'Term 1 Partial', amount: 20000, method: 'Net Banking', status: 'Success' },
  { id: 'TXN-9818', at: '2026-07-12 15:40', student: 'Meera Kapoor', branch: 'City Branch', head: 'Transport', amount: 9000, method: 'UPI · PhonePe', status: 'Pending' },
  { id: 'TXN-9817', at: '2026-07-12 11:05', student: 'Ishaan Verma', branch: 'Main Campus', head: 'Term 1 Partial', amount: 18500, method: 'UPI · Paytm', status: 'Refunded' },
]

// --- Audit / system log — every profile's actions ---------------------------
export const auditLogs = [
  { id: 'LOG-5011', at: '2026-07-13 10:24', actor: 'Anil Kulkarni', role: 'finance', branch: 'Main Campus', action: 'Recorded fee payment ₹38,500 for Aarav Mehta', module: 'Fees', ip: '103.21.58.10' },
  { id: 'LOG-5010', at: '2026-07-13 08:16', actor: 'Rahul Deshmukh', role: 'teacher', branch: 'Main Campus', action: 'Marked attendance for VIII-A (28 present, 2 absent)', module: 'Attendance', ip: '103.21.58.44' },
  { id: 'LOG-5009', at: '2026-07-13 08:02', actor: 'Priya Nair', role: 'admin', branch: 'Main Campus', action: 'Published Unit Test 1 marksheet to portal', module: 'Gradebook', ip: '103.21.58.2' },
  { id: 'LOG-5008', at: '2026-07-12 19:40', actor: 'Sunita Mehta', role: 'parent', branch: 'Main Campus', action: 'Paid Term 1 fees online (₹34,500)', module: 'Fees', ip: '49.36.112.9' },
  { id: 'LOG-5007', at: '2026-07-12 18:22', actor: 'Platform Admin', role: 'system', branch: '—', action: 'Suspended tenant “Sunrise Academy”', module: 'Platform', ip: '13.234.10.5' },
  { id: 'LOG-5006', at: '2026-07-12 16:10', actor: 'Anil Kulkarni', role: 'finance', branch: 'North Branch', action: 'Generated defaulters report (19 students)', module: 'Fees', ip: '103.21.58.10' },
  { id: 'LOG-5005', at: '2026-07-12 14:35', actor: 'Aarav Mehta', role: 'student', branch: 'Main Campus', action: 'Submitted assignment “Algebra Worksheet”', module: 'Assignments', ip: '49.36.100.71' },
  { id: 'LOG-5004', at: '2026-07-12 12:03', actor: 'Priya Nair', role: 'admin', branch: 'Main Campus', action: 'Created new branch “City Branch”', module: 'Branches', ip: '103.21.58.2' },
  { id: 'LOG-5003', at: '2026-07-12 09:47', actor: 'Rakesh Iyer', role: 'admin', branch: 'North Branch', action: 'Added 3 new admissions to enrollment', module: 'Admissions', ip: '103.21.60.8' },
  { id: 'LOG-5002', at: '2026-07-11 17:20', actor: 'Platform Admin', role: 'system', branch: '—', action: 'Provisioned tenant “Riverside International”', module: 'Platform', ip: '13.234.10.5' },
  { id: 'LOG-5001', at: '2026-07-11 15:00', actor: 'Anil Kulkarni', role: 'finance', branch: 'All', action: 'Approved fee concession for 2 students', module: 'Fees', ip: '103.21.58.10' },
]

// --- System Admin console — tenant schools on the platform ------------------
export const tenantSchools = [
  { id: 1, name: 'Greenwood Public School', code: 'greenwood', domain: 'greenwood.scholr.app', db: 'scholr_t_greenwood', branches: 3, students: 1284, status: 'Active', plan: 'Managed' },
  { id: 2, name: 'Riverside International', code: 'riverside', domain: 'riverside.scholr.app', db: 'scholr_t_riverside', branches: 1, students: 640, status: 'Active', plan: 'Managed' },
  { id: 3, name: 'Sunrise Academy', code: 'sunrise', domain: 'sunrise.scholr.app', db: 'scholr_t_sunrise', branches: 2, students: 410, status: 'Suspended', plan: 'Managed' },
]

export const systemKpis = { schools: 3, activeSchools: 2, branches: 6, totalStudents: 2334, uptime: 99.98 }
